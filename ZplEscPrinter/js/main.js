...
async function escpos(data,b64){
    ...
    if (!dataAux) { //empty
        console.log('[ESC/POS]  dataAux llave 1 ');
        ...
        console.log('[ESC/POS]  dataAux llave 2 ');
        ...
        console.log('[ESC/POS]  dataAux llave 3 ');
        ...
        console.log('[ESC/POS]  dataAux llave 4 ');
...
function startTcpServer() {
    ...
    // Do not set encoding, receive Buffer for raw data
        ...
        // Buffer para acumular los datos recibidos
        ...
        sock.on('end', async function () {
            ...
            try {
                // Manejo de HTTP POST (igual que antes)
                const regex = /POST.*\r\n\r\n/gs;
                let data = tcpBuffer;
                if (regex.test(data)) {
                ...
                if ($('#isZpl').is(':checked')) {
                    ...
                    // Convertir el buffer completo a base64, igual que Desktop
                    const base64 = Buffer.isBuffer(data) ? data.toString('base64') : Buffer.from(data, 'binary').toString('base64');
                    const response = await escpos(base64, true);
